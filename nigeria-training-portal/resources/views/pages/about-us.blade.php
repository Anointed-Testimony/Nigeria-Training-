...
<section class="py-14 lg:py-24 relative">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative ">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-9">
            <div class="img-box">
                <img src="https://img.freepik.com/free-photo/young-african-businessman-businesswoman-holding-digital-tablet-clipboard-looking-each-other_23-2148190654.jpg?t=st=1721560810~exp=1721564410~hmac=c238aa6961fbdfbdaf0f604dec9e7107892a1d55bf7effc2c4cea3d66e83ab0d&w=900" alt="About Us tailwind page"
            ...
            <div class="lg:pl-[100px] flex items-center">
                <div class="data w-full">
                    <h2
                        ...
                        About
                        Us </h2>
                    <p class="font-normal text-md leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                        Welcome to <span class="font-bold">Nigerian Training Portal</span> – Nigeria's all-in-one training hub!
                        Nigeria Training Portal is a leading management training aggregation and marketing website. We provide free, easy, up-to-date and by-the-click access to information on upcoming training, seminars, workshops, management and professional short courses and conferences to intending trainees / conference attendees in the comfort of their living rooms/offices anywhere in Nigeria and across the world We also provide information and access to training providers, venue providers, training equipment suppliers etc.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative ">
        <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-9 ">
            ...
            <div class="lg:pr-24 flex items-center">
                <div class="data w-full">
                    <img src="https://img.freepik.com/free-photo/medium-shot-people-looking-laptop_23-2149033795.jpg?t=st=1721560929~exp=1721564529~hmac=c3ba56171fffcb62afd06ce14c056c54f7c60db22df6a762788dbf824c3f989a&w=996" alt="About Us tailwind page"
                        class="block lg:hidden mb-9 mx-auto">
                    <p class="font-normal text-md leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                        We do not, and shall not evaluate, endorse or recommend any business (All adverts are at the instance of the advertisers). We will not engage in comparisons, surveys, or polls. Our business shall be limited to the provision of information and necessary links.
                        Our data is based on information available in the public domain and is constantly being updated by research and uploads/contribution by stakeholders.
                        Nigeria Training Portal is owned and managed by The Selected Success (our ref), a company duly registered under the Nigerian Company and Allied Matters Act 1990. 
                    </p>
                </div>
            </div>
            <div class="img-box ">
                <img src="https://img.freepik.com/free-photo/smiling-african-young-businessman-businesswoman-holding-clipboard-digital-tablet_23-2148190680.jpg?t=st=1721560880~exp=1721564480~hmac=83f0634f7a257596714ebdeb49601be05c2ea959ad4681706af2651937ed91b2&w=996" alt="About Us tailwind page"
...
<section class="py-20 bg-white">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col gap-3 items-center justify-center">
        <h2 class="font-manrope text-4xl text-center text-gray-900 font-bold mb-14">Our service offerings include the following:
            </h2>
        <div class="flex flex-col gap-5 xl:gap-8 lg:flex-row lg:justify-between">
            <div
                ...
                <div class="flex gap-5">
                    ...
                    <div class="flex-1">
                        <h4 class="text-xl text-gray-900 font-semibold mb-2">Free course listing</h4>
                        <p class="text-xs text-gray-500 leading-5">Explore our range of free courses and enhance your skills today!</p>
                    </div>
                </div>
            </div>
            <div
                ...
                <div class="flex gap-5">
                    ...
                    <div class="flex-1">
                        <h4 class="text-xl text-gray-900 font-semibold mb-2">Free business listing</h4>
                        <p class="text-xs text-gray-500 leading-5">List your business for free and reach a wider audience effortlessly!</p>
                    </div>
                </div>
            </div>
            <div
                ...
                <div class="flex gap-5">
                    ...
                    <div class="flex-1">
                        <h4 class="text-xl text-gray-900 font-semibold mb-2">Premium course/business listing (paid service)</h4>
                        <p class="text-xs text-gray-500 leading-5">Unlock premium courses with exclusive content and benefits!</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="flex flex-col gap-5 xl:gap-8 lg:flex-row justify-center">
            <div
                class="w-full max-lg:max-w-2xl mx-auto lg:mx-0 lg:w-1/3 bg-white p-6 rounded-2xl shadow-md shadow-gray-100">
                <div class="flex gap-5">
                    <div class="font-manrope text-2xl font-bold text-indigo-600">
                    ...
                    <div class="flex-1">
                        <h4 class="text-xl text-gray-900 font-semibold mb-2">Banner advert placement (paid service)</h4>
                        <p class="text-xs text-gray-500 leading-5">Advertise your brand with our banner placements for maximum impact!/p>
                    </div>
                </div>
            </div>
            <div
                ...
                <div class="flex gap-5">
                    ...
                    <div class="flex-1">
                        <h4 class="text-xl text-gray-900 font-semibold mb-2">Free training search </h4>
                        <p class="text-xs text-gray-500 leading-5">Search for free training programs and start learning immediately!</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class=" py-14 lg:py-24 bg-gray-50">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
      <div class="mb-16 rounded-full">
        <h2 class="text-4xl font-manrope font-bold text-gray-900 text-center">Explore Nigeria Training Portal</h2>
    </div>
    <div class="text-md text-center">
        Please feel free to relax and browse through the site by using the various tools we have provided. You may simply scroll up and down the pages or use the search options to search for events according to categories, location or date. <br><br>

        Do you have questions or suggestions for us? Please use the “contact us” button to drop us a line. For most common issues, you may find the answers in our FAQ page. <br><br>

        For advertising or premium listing subscription enquiries (training providers and other businesses), please visit our “advertise” and / or “premium listing” pages. Once again, you are welcome to Nigeria Training Portal. <br>
    </div>
    </div>
  </section>
