...
@section('content-pages')
    ...
    <section class="events-section">
        ...
        <div class="event-dates-container">
            <a href="#" class="year-link event" id="prevYear"><i class="fa-solid fa-angles-left"></i></a>
            <div style="text-align: center" class="event" id="currentYearMonth"></div>
            <a href="#" class="year-link event" id="nextYear"><i class="fa-solid fa-angles-right"></i></a>
        </div>
        <div class="events-month">
            <a href="#" class="month-link event" data-month="1">Jan</a>
            <a href="#" class="month-link event" data-month="2">Feb</a>
            <a href="#" class="month-link event" data-month="3">Mar</a>
            <a href="#" class="month-link event" data-month="4">April</a>
            <a href="#" class="month-link event" data-month="5">May</a>
            <a href="#" class="month-link event" data-month="6">June</a>
            <a href="#" class="month-link event" data-month="7">July</a>
            <a href="#" class="month-link event" data-month="8">Aug</a>
            <a href="#" class="month-link event" data-month="9">Sep</a>
            <a href="#" class="month-link event" data-month="10">Oct</a>
            <a href="#" class="month-link event" data-month="11">Nov</a>
            <a href="#" class="month-link event" data-month="12">Dec</a>
        </div>
        <div class="featured">
            <div class="events-container2">
                @if ($uploads->count() == 0)
                    <div style="position: absolute; left:50%; transform: translate(-50%)">No Events For this month</div>
                @else
