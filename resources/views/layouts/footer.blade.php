...
<footer class="scrollfooter">
    <div class="footer-overall-container pb-10 border-b border-gray-200">
        <div class="footer-logo">
            <img src="{{asset('assets/images/ntp-logo.png')}}" alt="">
            <p>Welcome To Nigeria Training Portal</p>
        </div>
        ...
        <div class="company-links">
            <h1 class="font-extrabold text-3xl">Important Links</h1>
            <ul>
                <li><a href="{{url('/currency-converter')}}">Currency Converter</a></li>
                <li><a href="{{url('/news')}}">New and Updates</a></li>
                <li><a href="">Place an Advert</a></li>
                <li><a href="">Become a Partner</a></li>
                <li><a href="">Join the Community</a></li>
            </ul>
        </div>
        {{-- <div class="company-links">
            <h1 class="font-extrabold text-3xl">Social Links</h1>
            <ul>
        ...
        <div class="company-links">
            <h1 class="font-extrabold text-3xl">Coming Soon</h1>
            <ul>
                <li><a href="{{url('/coming-soon')}}">Event Center</a></li>
                <li><a href="{{url('/coming-soon')}}">Equipment</a></li>
                <li><a href="{{url('/coming-soon')}}">Jobs</a></li>
            </ul>
        </div>
    </div>
    <div class="flex space-x-10 justify-center items-center mb-14 pt-4">
        <a href="https://x.com/NigeriaTraining" class="block  text-gray-900 transition-all duration-500 hover:text-[#65B741] ">
        ...
        <a href="https://www.instagram.com/nigeriatraining6?igsh=MWdhaGhpcW1mYnEydQ==" class="block  text-gray-900 transition-all duration-500 hover:text-[#65B741] ">
        ...
        <a href="#" class="block  text-gray-900 transition-all duration-500 hover:text-[#65B741] ">
        ...
        <a href="https://www.tiktok.com/@nigeriatrainingpo?_t=8p1nv3CVGRK&_r=1" class="block text-gray-900 transition-all duration-500 hover:text-[#65B741]">
            <i class="fa-brands fa-tiktok text-2xl"></i>
        </a>
        
    </div>
    <span class="text-lg text-white text-center block">©<a href="http://nigeriatrainingportal.com/">nigeriatrainingportal</a> 2024, All rights reserved.</span>
</footer>